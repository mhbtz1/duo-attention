...
class VQADataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_ids = torch.cat((torch.tensor([-200]), question_tokens, answer_tokens))
        labels = torch.cat((torch.tensor([-100]), torch.tensor([-100] * len(question_tokens)), answer_tokens))
