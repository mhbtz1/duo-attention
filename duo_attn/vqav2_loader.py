...
class VQAv2Dataset(MultiplePasskeyRetrievalDataset):

    def __init__(self, haystack_dataset=None, processor=None):
        print("VQAv2Dataset.__init__ called with:", haystack_dataset, processor)
        super(VQAv2Dataset, self).__init__(haystack_dataset, 
                                            processor.tokenizer, 
        ...
        self.all_items = [super(VQAv2Dataset, self).__getitem__(random.randint(0, len(self.context_length_intervals) - 1)) for _ in range(len(self.all_images))]
